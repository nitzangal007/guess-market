...
| 3 | `XmlMarketLoader` | `load` | Validate the path, create a fresh trusted-schema JAXB unmarshaller, close the XML stream, map the complete candidate, and preserve mapper failures without touching live state | All 13 `XmlMarketLoaderTest` cases | Implemented |
